...
package lb.com.thenet.netdriver.camerabarcode.barcodedetection;
...
class BarcodeFieldAdapter extends RecyclerView.Adapter<BarcodeFieldAdapter.BarcodeFieldViewHolder> {
  ...
  static class BarcodeFieldViewHolder extends RecyclerView.ViewHolder {
    ...
    static BarcodeResultFragment.onBarcodeClickListener _listener;

    static BarcodeFieldViewHolder create(ViewGroup parent, BarcodeResultFragment.onBarcodeClickListener listener) {
      View view =
    ...
    private BarcodeFieldViewHolder(View view) {
      ...
      valueView.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View v) {
          if(_listener != null) _listener.bacodeClicked(valueView.getText().toString());
        }
      });
    }
  ...
  private BarcodeResultFragment.onBarcodeClickListener _listener;

  BarcodeFieldAdapter(List<BarcodeField> barcodeFieldList, BarcodeResultFragment.onBarcodeClickListener listener) {
  ...
  public BarcodeFieldViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    return BarcodeFieldViewHolder.create(parent, _listener);
  }
